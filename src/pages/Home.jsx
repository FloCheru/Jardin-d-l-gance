      ...
      <div className="container relative h-screen">
        ...
        <div className="relative z-20 flex flex-col justify-between gap-[var(--padding-m)] w-full h-full ">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex flex-col items-start gap-2 satisfied-clients p-[var(--padding-s)]">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="z-21 relative flex flex-col items-center gap-[20px] p-[var(--padding-m)] w-[40%] bg-white">
              {/* Overlay sombre pour lisibilité */}
              ...
              <div>
                ...
                <div className="font-normal text-[var(--color-secondary)]">
                  We design Hachioji Garden as a part of our new Landscape
                  Design Commission in the country
                </div>
              </div>
            </div>
          </div>
